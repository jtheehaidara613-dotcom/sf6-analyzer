...
# ---------------------------------------------------------------------------
# 解析パラメータ定数（調整が必要な場合はここだけ変更する）
# ---------------------------------------------------------------------------

MAX_DRIVE: int = 10000                # ドライブゲージ最大値
BURNOUT_DRIVE_THRESH: int = 300       # ドライブ ≤ この値 → バーンアウト圏
LETHAL_HP_RATIO: float = 0.20         # HP比率がこれ未満 → リーサル圏
ROUND_RESET_RATIO: float = 1.15       # 前スナップ比でこれ以上HP増加 → ラウンドリセット
